  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h3 className="text-sm font-bold text-gray-800">Danh mục giá phẫu thuật</h3>
        ...
        <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-3 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-5 gap-2">
            <div className="sm:col-span-2">
              <label className="text-[10px] font-semibold text-gray-600 mb-0.5 block">Tên kỹ thuật *</label>
              <input
                value={editRow.tenKT}
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  >
                    Tên kỹ thuật <SortIcon field="tenKT" />
                  </th>
                  <th
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-2 text-gray-800 font-medium">
                        {p.tenKT}
                        {p.note && <span className="text-gray-400 ml-2 font-normal">• {p.note}</span>}
                      </td>
